...
class Player:
    def __init__(self, args):
        ...
        self.meta_path = os.path.join(self.play_dir, "{}.meta".format(self.play_epoch))
...
if __name__ == "__main__":
    ...
    #python play.py --env FetchSlide-v1 --goal custom --play_path policies/FetchReach/1310-ddpg-FetchReach-v1-hgg-stop/ --play_epoch best
    args = get_args()
    ...
    DEFAULT_ENV = Env_config(
        ...
        size=[0, 0, 0],
        type="box",
        mujoco_path="Env_configs/push3.xml",
    counter=1)
    args.env_config = DEFAULT_ENV
    print("------")
    args.env = "FetchPush-v1"
    args.play_path = "/media/erdi/04D5-5A07/backup_done/hgg_poet_results/FetchPush/paper_plots/FetchPush/coher_data/20221222094553_10d5c/debug/tf_data/goal_center3/"
