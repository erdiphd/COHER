...
class FetchEnv(robot_env.RobotEnv):
    ...
    def __init__(
        ...
        distance_threshold, initial_qpos, reward_type,target_range_x,target_range_y,obj_range_x,obj_range_y
    ):
        ...
        self.target_range_x = target_range_x  # entire table: 0.125
        self.target_range_y = target_range_y  # entire table: 0.175

        self.obj_range_x = obj_range_x
        self.obj_range_y = obj_range_y
    ...
    def _env_setup(self, initial_qpos):
        ...
        # intermediate_goal_id = self.sim.model.site_name2id('intermediate_goal')
        # self.sim.model.site_pos[intermediate_goal_id] = self.init_center + [-self.obj_range_x, -self.obj_range_y, 0.0] - table_position
