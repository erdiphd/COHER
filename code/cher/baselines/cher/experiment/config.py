...
def prepare_params(kwargs):
    ...
    if kwargs['env_name'] == "FrankaPickAndPlace-v1":
        ...
        raise AssertionError("The given environments are not valid!. Choose either FrankaPickAndPlace-v1 or FetchPush.") 
    env_name = kwargs['env_name']
    def make_env():
        return gym.make(env_name,env_config=test_env)
